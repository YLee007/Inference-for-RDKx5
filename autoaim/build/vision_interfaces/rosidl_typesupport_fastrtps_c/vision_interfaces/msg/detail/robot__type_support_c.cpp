...
#include "vision_interfaces/msg/detail/robot__rosidl_typesupport_fastrtps_c.h"
...
using _Robot__ros_msg_type = vision_interfaces__msg__Robot;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: foe_color
  {
    cdr << ros_message->foe_color;
  }

  // Field name: self_yaw
  {
    cdr << ros_message->self_yaw;
  }

  // Field name: self_pitch
  {
    cdr << ros_message->self_pitch;
  }

  // Field name: muzzle_speed
  {
    cdr << ros_message->muzzle_speed;
  }
...
size_t get_serialized_size_vision_interfaces__msg__Robot(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  ...
  // field.name foe_color
  {
    size_t item_size = sizeof(ros_message->foe_color);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // field.name self_yaw
  {
    size_t item_size = sizeof(ros_message->self_yaw);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // field.name self_pitch
  {
    size_t item_size = sizeof(ros_message->self_pitch);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // field.name muzzle_speed
  {
    size_t item_size = sizeof(ros_message->muzzle_speed);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
...
static uint32_t _Robot__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_vision_interfaces__msg__Robot(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_vision_interfaces
size_t max_serialized_size_vision_interfaces__msg__Robot(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = vision_interfaces__msg__Robot;
    is_plain =
      (
      offsetof(DataType, muzzle_speed) +
      last_member_size
      ) == ret_val;
  }
...
static size_t _Robot__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_vision_interfaces__msg__Robot(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, vision_interfaces, msg, Robot)() {
