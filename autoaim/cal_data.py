...
src_root = '/home/ylee/armor_dataset_v4/images'  # 原始图像文件夹路径
cal_img_num = 200  # 想要的图像个数
dst_root = '/home/ylee/horizon_x5_open_explorer_v1.2.8-py310_20240926/cal_data'  # 校准数据存放路径
